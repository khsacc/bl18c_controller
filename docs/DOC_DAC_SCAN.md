...
![](./assets/dac_scan/screenshot_2D_scan.jpg)
...
> [!IMPORTANT]
> フィッティングを適切に行うことで、粗いスキャンから十分に正確なデータが得られ、結果として時間短縮につながると考えられます。テスト測定の結果を [テスト：フィッティングを行うことによる時間短縮の効果](./DOC_SUB_DAC_SCAN_ROUGH_CALIB.md) にまとめているので参照ください。
